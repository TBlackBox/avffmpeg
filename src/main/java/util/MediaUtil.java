...
import domain.ImageMetaInfo;
import domain.MusicMetaInfo;
import domain.VideoMetaInfo;
import domain.gif.AnimatedGifEncoder;
...
public class MediaUtil {
     ...
     */
	private static String FFMPEG_PATH = "D:\\Jason\\project\\code\\avffmpeg\\src\\main\\java\\ffmpeg\\ffmpeg.exe"; // /usr/bin/ffmpeg
